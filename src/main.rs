...
fn star(mut commands: Commands, mut meshes: ResMut<Assets<Mesh>>) {
    ...
    for i in 0..10 {
        ...
        let color = [Color::ORANGE, Color::YELLOW, Color::RED][(i % 3) as usize];
        v_color.push(color.as_linear_rgba_u32());
    }

    // run triangulate
    let triangles = Builder::new((points, v_color))
        // add center
        .add_steiner_point(Point::new(0., 0.), Color::WHITE.as_linear_rgba_u32())
        // add center hole
        .add_hole((
            vec![
                Point::new(-35., -55.),
            ...
            vec![Color::WHITE.as_linear_rgba_u32(); 4],
        ))
        // add left eye
        .add_hole((
            vec![
            ...
            vec![Color::RED.as_linear_rgba_u32(); 4],
        ))
        // add right eye
        .add_hole((
            vec![
